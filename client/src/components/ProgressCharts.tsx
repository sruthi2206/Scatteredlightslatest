...
import { EmotionTooltip, ChakraTooltip } from "@/components/ui/animated-chart-tooltip";
...
export default function ProgressCharts({ journalEntries = [], emotionTrackings = [], chakraProfile }: ProgressChartsProps) {
  ...
  const calculateOverallProgress = () => {
    ...
    if (!chakraProfile || journalEntries.length === 0 ) {
      return 0;
                  ...
                  >
                    ...
                    {selectedEmotions.map((emotion) => (
                      <Area
                        ...
                        fill={EMOTION_COLORS[emotion as keyof typeof EMOTION_COLORS] + '30'}
                        activeDot={{ r: 6 }}
                        stackId="1"
                      />
                    ))}
